...
#' InactivationComparison class
#' 
#' @description 
#' The `InactivationComparison` class contains several functions for model comparison
...
#' `InactivationComparison` implements two S3 methods to obtain numerical values to facilitate
...
#' 
#' @name InactivationComparison
#'   
NULL

#' @describeIn InactivationComparison illustrations comparing the fitted models
#' 
#' @param x an instance of [InactivationComparison]
#' @param y ignored
#' @param ... ignored
...
#' @export
#' 
plot.InactivationComparison <- function(x, y, ...,
                                  type = 1,
                                  add_trend = TRUE) {
...
#' @describeIn InactivationComparison table of parameter estimates
#' 
#' @param object an instance of [InactivationComparison]
#' @param ... ignored
#' 
...
#' @export
#' 
coef.InactivationComparison <- function(object, ...) {
...
#' @describeIn InactivationComparison print of the model comparison
#' 
#' @param x an instance of [InactivationComparison]
#' @param ... ignored
#' 
#' @export
#' 
print.InactivationComparison <- function(x, ...) {
...
#' @describeIn InactivationComparison summary table for the comparison
#' 
#' @param object an instance of [InactivationComparison]
#' @param ... ignored
#' 
...
#' @export
#' 
summary.InactivationComparison <- function(object, ...) {
