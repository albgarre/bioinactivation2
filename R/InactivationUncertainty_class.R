...
#' InactivationUncertainty class
#'
#' @description
#' `r lifecycle::badge("stable")`
#'
#' The `InactivationUncertainty` class contains the results of an inactivation prediction
#' under isothermal conditions considering parameter uncertainty. Its constructor
#' is [predict_inactivation_uncertainty()].
#'
...
#' }
#'
#' @name InactivationUncertainty
#'
NULL

#' @describeIn InactivationUncertainty print of the model
#'
#' @param x An instance of `InactivationUncertainty`.
#' @param ... ignored
#'
#' @export
#'
print.InactivationUncertainty <- function(x, ...) {

  cat("Inactivation prediction based on primary models with parameter uncertainty\n\n")
...
#' @describeIn InactivationUncertainty Growth prediction (prediction band) considering
#' parameter uncertainty.
#'
#' @param x The object of class `InactivationUncertainty` to plot.
#' @param y ignored
#' @param ... ignored.
...
#'
plot.InactivationUncertainty <- function(x, y=NULL, ...,
                                   line_col = "black",
                                   line_size = 0.5,
                                   line_type = "solid",
                                   ribbon80_fill = "grey",
