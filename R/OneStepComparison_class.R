...
#' OneStepComparison class
#' 
#' @description 
#' The `OneStepComparison` class contains several functions for model comparison
...
#' `OneStepComparison` implements two S3 methods to obtain numerical values to facilitate
...
#' 
#' @name OneStepComparison
#'   
NULL

#' @describeIn OneStepComparison illustrations comparing the fitted models
#' 
#' @param x an instance of [OneStepComparison]
#' @param y ignored
#' @param ... ignored
...
#' @export
#' 
plot.OneStepComparison <- function(x, y, ...,
                                        type = 1,
                                        add_trend = TRUE) {
  
  if (type == 1) {  # Plot of the parameter estimates
  ...
  } else if (type == 2) {  # Plot of the residuals
...
#' @describeIn OneStepComparison table of parameter estimates
#' 
#' @param object an instance of [OneStepComparison]
#' @param ... ignored
#' 
...
#' @export
#' 
coef.OneStepComparison <- function(object, ...) {
...
#' @describeIn OneStepComparison print of the model comparison
#' 
#' @param x an instance of [OneStepComparison]
#' @param ... ignored
#' 
#' @export
#' 
print.OneStepComparison <- function(x, ...) {
...
#' @describeIn OneStepComparison summary table for the comparison
#' 
#' @param object an instance of [OneStepComparison]
#' @param ... ignored
#' 
...
#' @export
#' 
summary.OneStepComparison <- function(object, ...) {
